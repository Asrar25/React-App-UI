...
export default function ApplicantCertification(){
    ...
    return (
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div class="flex items-center justify-between">
            ...
            <button class=" mx- bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={submitData}>
              Next
            </button>
          </div>
