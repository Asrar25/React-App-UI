  ...
  return (
    ...
    <form class="bg-white shadow-md rounded px-4 pt-6 pb-8 mb-4">
        <div className="px-4">
            ...
            <textarea rows="4" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline resize-none" name="Qualification" onChange={handleinput}></textarea>
        </div>
